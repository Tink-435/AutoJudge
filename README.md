...
Text is lowercased and cleaned
This ensures that the complete context of each problem is captured
...
Though Random Forest Regressor achieves the lowest MAE and RMSE among all evaluated models,so it is used as the final backbone model of the system.
...
- Includes a “How does this work?” section explaining the modeling approach
